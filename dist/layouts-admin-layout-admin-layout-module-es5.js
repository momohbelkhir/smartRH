...
var DashboardComponent = /** @class */ (function () {
    function DashboardComponent(authService, formBuilder) {
        this.authService = authService;
        this.formBuilder = formBuilder;
        this.listProfils = [];
        this.listProfilsPrincipal = [];
    }
    Object.defineProperty(DashboardComponent.prototype, "formControls", {
    ...
    DashboardComponent.prototype.addToFavories = function (profil) {
        console.log(profil);
    ...
    DashboardComponent.prototype.onSearchChange = function (searchValue) {
        console.log(searchValue);
        var profilsSearched = [];
        for (var i = 0; i < this.listProfilsPrincipal.length; i++) {
    ...
    DashboardComponent.prototype.initRechercheForm = function () {
...
var TableComponent = /** @class */ (function () {
    function TableComponent(authService) {
        this.authService = authService;
        this.listDesFavories = [];
    }
    TableComponent.prototype.chatter = function () {
